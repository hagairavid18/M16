...
public abstract class Subscriber extends RunnableSubPub {
    ...
    //private String name;
    private Map<Class<? extends Message >,Callback> callBackMap; // this is a map for everyone who extends subscriber
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callBackMap.put(type,callback); //insert callback to specific subscriber's callBackMap
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if (m!=null) {
                    this.callBackMap.get(m.getClass()).call(m);
                }
